package("edopro-core")
    ...
    on_install("linux", function (package)
        -- Chunk-1 overlay (see header comment): mirror serialize/ from the
        -- ocgcore submodule working copy onto the fetched source. The fork
        -- doesn't carry serialize/ yet; this lets the local xmake build see
        -- it without requiring a fork push. Only .proto and Makefile are
        -- needed — .pb.cc/.pb.h are generated by xmake's protobuf.cpp rule
        -- at build time. Remove this os.cp call once the fork SHA is bumped
        -- in chunk 7.
        --
        -- TODO(chunk-7): delete this entire overlay block. The fork SHA bump
        -- in chunk 7 makes serialize/ part of the fetched source directly.
