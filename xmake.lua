...
target("serialize_9a_tier2_characterize")
    set_kind("binary")
    set_languages("c++17")
    set_default(false)
    on_load(function (target)
    ...
    add_files(ocgcore_serialize .. "/tests/measure_9a_tier2_characterize.cpp")
    add_files(ocgcore_serialize .. "/ocg_state.pb.cc")
    add_includedirs(ocgcore_serialize, ocgcore_serialize .. "/..")
    add_packages("edopro-core", "protobuf-cpp")

-- Chunk 10 — save/load perf benchmarks across chunk-5/9a fixtures.
target("serialize_perf_measure")
    set_kind("binary")
    set_languages("c++17")
    set_default(false)
    on_load(function (target)
    ...
    add_files(ocgcore_serialize .. "/tests/measure_perf.cpp")
    add_files(ocgcore_serialize .. "/ocg_state.pb.cc")
    add_includedirs(ocgcore_serialize, ocgcore_serialize .. "/..")
    add_packages("edopro-core", "protobuf-cpp")
